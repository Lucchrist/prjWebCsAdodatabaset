<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webDatasetlocal.aspx.cs" Inherits="prjWebCsAdodatabaset.webDatasetlocal" %>
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <asp:ListBox ID="lstEquipes"  OnSelectedIndexChanged="lstEquipes_selectdIndexChanged" runat ="server" AutoPostBack="True" Font-Bold="True" ForeColor="Blue" Height="100" Width="200"></asp:ListBox>
                    </td>
                    <td>
